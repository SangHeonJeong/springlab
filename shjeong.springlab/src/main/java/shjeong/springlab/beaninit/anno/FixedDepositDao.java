package shjeong.springlab.beaninit.anno;
...
public class FixedDepositDao {
    ...
    public static void main(String[] args) {
        AbstractApplicationContext context = new ClassPathXmlApplicationContext("classpath:spring/beaninit/context-anno.xml");
